...
class CourseDetail8 extends StatefulWidget {
  @override
  _CourseDetail8State createState() => _CourseDetail8State();
}

class _CourseDetail8State extends State<CourseDetail8> {
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: 'Lists in Python are ordered collections of items that can be of any data type. Here are some examples:\n\n',
                  ),
