...
class CourseDetail5 extends StatefulWidget {
  @override
  _CourseDetail5State createState() => _CourseDetail5State();
}

class _CourseDetail5State extends State<CourseDetail5> {
            ...
            RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  TextSpan(
                    text: 'Typecasting in Python is used to convert a value from one data type to another. Here are some examples:\n\n',
                  ),
